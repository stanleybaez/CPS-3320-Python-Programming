...
# Title
        self.controller.title('Simplesecure')
        self.controller.state('zoomed')
#Icon
        self.controller.iconphoto(False,tk.PhotoImage(file='C:/Users/yesse/PycharmProjects/ATM-master/atm-machine.png'))
        ...
        space_label = tk.Label(self,height=4,bg='grey')
        space_label.pack()
...
class DepositPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        two_tone_label = tk.Label(self,bg='grey')
